...
with st.sidebar:  
      ...
      km = st.number_input("Média de KM rodados por ANo",min_value=5000, max_value=80000, value=30000)
...
if tela == 1:
   ...
   col1.subheader("Alugar " )
   col2.subheader("Comprar" )
   col3.subheader("Menos "+ str(int(residual*100))+ " % Residual - " + str(f'R${valor*residual:,,2f}') )
   result_alugar_comprar = (((soma_comprar-soma_aluguel)/soma_aluguel)*100)
